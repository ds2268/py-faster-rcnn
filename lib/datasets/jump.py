...
class jump(imdb):
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_jump_annotation(index)
    ...
    def _load_jump_annotation(self, index):
        """
    ...
    def _write_jump_results_file(self, all_boxes):
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        comp_id = self._write_jump_results_file(all_boxes)
